 ...
 *   type2 = term2's type
 */
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_ite(fuzz::bool_term cond, fuzz::bv_term then_term, fuzz::bv_term else_term);
 ...
 *   type2 = term2's type
 */
__YICES_DLLSPEC__ extern fuzz::bool_term __attribute__((annotate("expose"))) yices_eq(fuzz::bv_term left, fuzz::bv_term right);
__YICES_DLLSPEC__ extern fuzz::bool_term __attribute__((annotate("expose"))) yices_neq(fuzz::bv_term left, fuzz::bv_term right);
 ...
 *
 */
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvadd(fuzz::bv_term t1, fuzz::bv_term t2);     // addition (t1 + t2)
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvsub(fuzz::bv_term t1, fuzz::bv_term t2);     // subtraction (t1 - t2)
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvneg(fuzz::bv_term t1);                // negation (- t1)
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvmul(fuzz::bv_term t1, fuzz::bv_term t2);     // multiplication (t1 * t2)
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvsquare(fuzz::bv_term t1);             // square (t1 * t1)
__YICES_DLLSPEC__ extern fuzz::bv_term yices_bvpower(fuzz::bv_term t1, uint32_t d);  // exponentiation (t1 ^ d)

__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvdiv(fuzz::bv_term t1, fuzz::bv_term t2);   // unsigned div
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvrem(fuzz::bv_term t1, fuzz::bv_term t2);   // unsigned rem
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvsdiv(fuzz::bv_term t1, fuzz::bv_term t2);  // signed div
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvsrem(fuzz::bv_term t1, fuzz::bv_term t2);  // signed rem
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvsmod(fuzz::bv_term t1, fuzz::bv_term t2);  // signed mod

__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvnot(fuzz::bv_term t1);              // bitwise not
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvnand(fuzz::bv_term t1, fuzz::bv_term t2);  // bitwise not and
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvnor(fuzz::bv_term t1, fuzz::bv_term t2);   // bitwise not or
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvxnor(fuzz::bv_term t1, fuzz::bv_term t2);  // bitwise not xor

__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvshl(fuzz::bv_term t1, fuzz::bv_term t2);   // shift t1 left by k bits where k = value of t2
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvlshr(fuzz::bv_term t1, fuzz::bv_term t2);  // logical shift t1 right by k bits, where k = value of t2
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvashr(fuzz::bv_term t1, fuzz::bv_term t2);  // arithmetic shift t1 right by k bits, k = value of t2
...
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvand2(fuzz::bv_term t1, fuzz::bv_term t2);
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvor2(fuzz::bv_term t1, fuzz::bv_term t2);
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvxor2(fuzz::bv_term t1, fuzz::bv_term t2);

__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvand3(fuzz::bv_term t1, fuzz::bv_term t2, fuzz::bv_term t3);
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvor3(fuzz::bv_term t1, fuzz::bv_term t2, fuzz::bv_term t3);
__YICES_DLLSPEC__ extern fuzz::bv_term __attribute__((annotate("expose"))) yices_bvxor3(fuzz::bv_term t1, fuzz::bv_term t2, fuzz::bv_term t3);
 ...
 */
__YICES_DLLSPEC__ extern fuzz::bool_term __attribute__((annotate("expose"))) yices_bveq_atom(fuzz::bv_term t1, fuzz::bv_term t2);   // t1 == t2
__YICES_DLLSPEC__ extern fuzz::bool_term __attribute__((annotate("expose"))) yices_bvneq_atom(fuzz::bv_term t1, fuzz::bv_term t2);  // t1 != t2


/*
 * Unsigned inequalities
 */
__YICES_DLLSPEC__ extern fuzz::bool_term __attribute__((annotate("expose"))) yices_bvge_atom(fuzz::bv_term t1, fuzz::bv_term t2);  // t1 >= t2
__YICES_DLLSPEC__ extern fuzz::bool_term __attribute__((annotate("expose"))) yices_bvgt_atom(fuzz::bv_term t1, fuzz::bv_term t2);  // t1 > t2
__YICES_DLLSPEC__ extern fuzz::bool_term __attribute__((annotate("expose"))) yices_bvle_atom(fuzz::bv_term t1, fuzz::bv_term t2);  // t1 <= t2
__YICES_DLLSPEC__ extern fuzz::bool_term __attribute__((annotate("expose"))) yices_bvlt_atom(fuzz::bv_term t1, fuzz::bv_term t2);  // t1 < t2


/*
 * Signed inequalities
 */
__YICES_DLLSPEC__ extern fuzz::bool_term __attribute__((annotate("expose"))) yices_bvsge_atom(fuzz::bv_term t1, fuzz::bv_term t2);  // t1 >= t2
__YICES_DLLSPEC__ extern fuzz::bool_term __attribute__((annotate("expose"))) yices_bvsgt_atom(fuzz::bv_term t1, fuzz::bv_term t2);  // t1 > t2
__YICES_DLLSPEC__ extern fuzz::bool_term __attribute__((annotate("expose"))) yices_bvsle_atom(fuzz::bv_term t1, fuzz::bv_term t2);  // t1 <= t2
__YICES_DLLSPEC__ extern fuzz::bool_term __attribute__((annotate("expose"))) yices_bvslt_atom(fuzz::bv_term t1, fuzz::bv_term t2);  // t1 < t2
