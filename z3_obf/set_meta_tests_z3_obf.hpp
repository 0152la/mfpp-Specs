...
namespace checks {
    ...
    check_expr_same_sat(z3::context& c, z3::expr e1, z3::expr e2)
    {
        ...
        z3::expr_vector add_obf_v(c);
        add_obf_v.push_back(conjecture);
#ifdef OBFUSCATE
        z3::expr x = c.int_const("x"), y = c.int_const("y");
        z3::expr obf1 = (2 * x * y == 30);
        z3::expr obf2 = (z3::pw(x, 2) + y == 14);
        add_obf_v.push_back(obf1);
        add_obf_v.push_back(obf2);
#endif
        z3::expr to_solve = z3::mk_and(add_obf_v);
        solver.add(to_solve);
