...
class __attribute__((annotate("expose"))) ctx {
  isl_ctx *ptr;
public:
...
class __attribute__((annotate("expose"))) basic_set;
...
class __attribute__((annotate("expose"))) local_space;
class map;
class map_list;
class mat;
class multi_aff;
...
class schedule_node;
class __attribute__((annotate("expose"))) set;
class set_list;
class __attribute__((annotate("expose"))) space;
class term;
...
class __attribute__((annotate("expose"))) val;
class val_list;
class vec;
...
public:
  ...
  inline __attribute__((annotate("expose"))) isl::set eq_set(isl::pw_aff pwaff2) const;
  inline isl::val eval(isl::point pnt) const;
  inline int find_dim_by_name(isl::dim type, const std::string &name) const;
  ...
  inline __attribute__((annotate("expose"))) isl::set ne_set(isl::pw_aff pwaff2) const;
...
public:
  ...
  inline __attribute__((annotate("expose"))) isl::val two_exp() const;
  inline __attribute__((annotate("expose"))) isl::val abs() const;
  inline isl::boolean abs_eq(const isl::val &v2) const;
  inline __attribute__((annotate("expose"))) isl::val add(isl::val v2) const;
  inline isl::val add_ui(unsigned long v2) const;
  inline __attribute__((annotate("expose"))) isl::val ceil() const;
  ...
  inline __attribute__((annotate("expose"))) isl::val floor() const;
  ...
  inline __attribute__((annotate("expose"))) isl::val inv() const;
  ...
  inline __attribute__((annotate("expose"))) isl::val max(isl::val v2) const;
  inline __attribute__((annotate("expose"))) isl::val min(isl::val v2) const;
  inline isl::val mod(isl::val v2) const;
  inline __attribute__((annotate("expose"))) isl::val mul(isl::val v2) const;
  ...
  inline __attribute__((annotate("expose"))) isl::val neg() const;
  ...
  inline int sgn() const;
  inline __attribute__((annotate("expose"))) isl::val sub(isl::val v2) const;
  inline isl::val sub_ui(unsigned long v2) const;
  inline __attribute__((annotate("expose"))) isl::val trunc() const;
