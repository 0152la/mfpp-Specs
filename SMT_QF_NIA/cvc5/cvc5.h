 ...
 */
class __attribute__((annotate("expose"))) CVC5_EXPORT Sort
{
 ...
 * A cvc5 Term.
 */
class __attribute__((annotate("expose"))) CVC5_EXPORT Term
{
  friend class cvc5::Command;
 ...
 * A cvc5 solver.
 */
class __attribute__((annotate("expose"))) CVC5_EXPORT Solver
{
  friend class Datatype;
  friend class DatatypeDecl;
  friend class DatatypeConstructor;
 ...
 public:
   ...
   */
  Term __attribute__((annotate("expose"))) mkInteger(int64_t val) const;
