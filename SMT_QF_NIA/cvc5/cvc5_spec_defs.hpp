#ifndef _CVC5_SPEC_DEFS_HPP
#define _CVC5_SPEC_DEFS_HPP
...
make_int_div_expr(fuzz::fuzz_context& ctx, fuzz::int_term lhs, int rhs_int)
{
    ...
    return ctx.slv.mkTerm(cvc5::api::Kind::ITE,
        ctx.slv.mkTerm(cvc5::api::Kind::EQUAL, ctx.slv.mkInteger(0), rhs),
        lhs, ctx.slv.mkTerm(cvc5::api::Kind::INTS_DIVISION, lhs, rhs));
}
...
{
    return ctx.slv.mkTerm(cvc5::api::Kind::ITE, cond, lhs, rhs);
}
