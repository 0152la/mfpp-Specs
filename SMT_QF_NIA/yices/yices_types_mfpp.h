...
namespace fuzz
{
    __attribute__((annotate("expose"))) typedef term_t int_term;
 ...
 */
__attribute__((annotate("expose"))) typedef struct context_s context_t;
 ...
 */
__attribute__((annotate("expose"))) typedef struct ctx_config_s ctx_config_t;
