#include "/home/sentenced/Documents/Internships/2018_ETH/work/spec_ast/input/cvc4/spec_fuzz.hpp"
...
{
    return slv.mkTerm(CVC4::api::Kind::TO_INTEGER, slv.mkTerm(CVC4::api::Kind::DIVISION_TOTAL, lhs, rhs));
}

CVC4::api::Term
make_int_div_expr(CVC4::api::Solver& slv, CVC4::api::Term lhs, CVC4::api::Term rhs)
{
    return slv.mkTerm(CVC4::api::Kind::INTS_DIVISION_TOTAL, lhs, rhs);
}

CVC4::api::Term
make_int_mod_expr(CVC4::api::Solver& slv, CVC4::api::Term lhs, CVC4::api::Term rhs)
{
    return slv.mkTerm(CVC4::api::Kind::INTS_MODULUS_TOTAL, lhs, rhs);
}
...
main(int argc, char** argv)
{
    ...
    fuzz::start();
    fuzz::output_var = slv.mkReal(fuzz::fuzz_rand(-20, 20));
