 ...
 *
 */
__YICES_DLLSPEC__ extern term_t __attribute__((annotate("expose"))) yices_bvadd(term_t t1, term_t t2);     // addition (t1 + t2)
__YICES_DLLSPEC__ extern term_t __attribute__((annotate("expose"))) yices_bvsub(term_t t1, term_t t2);     // subtraction (t1 - t2)
__YICES_DLLSPEC__ extern term_t __attribute__((annotate("expose"))) yices_bvneg(term_t t1);                // negation (- t1)
__YICES_DLLSPEC__ extern term_t __attribute__((annotate("expose"))) yices_bvmul(term_t t1, term_t t2);     // multiplication (t1 * t2)
__YICES_DLLSPEC__ extern term_t __attribute__((annotate("expose"))) yices_bvsquare(term_t t1);             // square (t1 * t1)
__YICES_DLLSPEC__ extern term_t yices_bvpower(term_t t1, uint32_t d);  // exponentiation (t1 ^ d)

__YICES_DLLSPEC__ extern term_t __attribute__((annotate("expose"))) yices_bvdiv(term_t t1, term_t t2);   // unsigned div
__YICES_DLLSPEC__ extern term_t __attribute__((annotate("expose"))) yices_bvrem(term_t t1, term_t t2);   // unsigned rem
__YICES_DLLSPEC__ extern term_t __attribute__((annotate("expose"))) yices_bvsdiv(term_t t1, term_t t2);  // signed div
__YICES_DLLSPEC__ extern term_t __attribute__((annotate("expose"))) yices_bvsrem(term_t t1, term_t t2);  // signed rem
__YICES_DLLSPEC__ extern term_t __attribute__((annotate("expose"))) yices_bvsmod(term_t t1, term_t t2);  // signed mod

__YICES_DLLSPEC__ extern term_t __attribute__((annotate("expose"))) yices_bvnot(term_t t1);              // bitwise not
__YICES_DLLSPEC__ extern term_t __attribute__((annotate("expose"))) yices_bvnand(term_t t1, term_t t2);  // bitwise not and
